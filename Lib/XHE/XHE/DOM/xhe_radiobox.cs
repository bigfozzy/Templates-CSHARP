...
{
    //////////////////////////////////////////////////// RadioBox ///////////////////////////////////////////////
    public class XHERadioButton : XHEBaseDOMVisual
    {
        //////////////////////////////////////// SERVICVE FUNCTIONS /////////////////////////////////////////
        // server initialization
        public XHERadioButton(string server, string password, XHEScriptBase script)
            : base(server, password)
        {
            Script = script;
            m_Prefix = "RadioButton";
        }
        /////////////////////////////////////////////////////////////////////////////////////////////////////

        /////////////////////////////////////////////////////////////////////////////////////////////////////

        // кликнуть по имени и значению (old - need replace) (no wait exist mode)
        public bool click_by_name_and_value(string name, string value = "", string frame = "-1")
        {
            return z_click_by_name_and_value(name, value, frame);
        }
        ...
        public bool check_by_value(string value, int exactly, bool check, string frame = "-1")
        {
            ...
            string[,] aParams = new string[,] { { "value", value }, { "exactly", exactly.ToString() }, { "check", check.ToString() }, { "frame", frame } };
            return call_boolean(MethodBase.GetCurrentMethod().Name, aParams);
        }
        ...
        public bool check_by_attribute(string attr_name, string attr_value, int exactly, bool check, string frame = "-1")
        {
            ...
            string[,] aParams = new string[,] { { "attr_value", attr_value }, { "attr_name", attr_name }, { "exactly", exactly.ToString() }, { "check", check.ToString() }, { "frame", frame } };
            return call_boolean(MethodBase.GetCurrentMethod().Name, aParams);
        }
        ...
        {
            string[,] aParams = new string[,] { { "attr_value", attr_value }, { "attr_name", attr_name }, { "exactly", exactly.ToString() }, { "check", check.ToString() }, { "form_number", form_number.ToString() }, { "frame", frame } };
            return call_boolean(MethodBase.GetCurrentMethod().Name, aParams);
        }
        ...
        {
            string[,] aParams = new string[,] { { "attr_value", attr_value }, { "attr_name", attr_name }, { "exactly", exactly.ToString() }, { "check", check.ToString() }, { "form_name", form_name }, { "frame", frame } };
            return call_boolean(MethodBase.GetCurrentMethod().Name, aParams);
        }
